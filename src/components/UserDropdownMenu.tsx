    ...
    <DropdownMenu.Root onOpenChange={setIsOpen}>
      <DropdownMenu.Trigger asChild>
        ...
        >
          ...
          <span
            className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 h-1 bg-gradient-to-r from-orange-800 to-orange-500 transition-all duration-300 ${isOpen ? 'w-4/5' : 'w-0'
              }`}
            style={{
