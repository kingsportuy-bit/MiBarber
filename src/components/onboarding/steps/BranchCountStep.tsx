    ...
    return (
        ...
        >
            <div className="space-y-2 text-center">
                <div className="w-20 h-20 bg-slate-800/50 rounded-none flex items-center justify-center mx-auto mb-6 border border-white/10 shadow-[0_0_30px_rgba(139,92,246,0.2)]">
            ...
            <div className="flex items-center justify-center gap-8 py-10">
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-14 h-14 rounded-full bg-none bg-slate-900/50 border border-slate-700 text-white text-2xl font-bold flex items-center justify-center transition-colors shadow-lg shadow-black/20"
                >
                    -
                </motion.button>

                <div className="w-40 h-40 rounded-none bg-slate-900 border border-violet-500/30 flex items-center justify-center relative overflow-hidden group shadow-2xl shadow-violet-900/20">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="w-14 h-14 rounded-none bg-none bg-slate-900/50 border border-slate-700 text-white text-2xl font-bold flex items-center justify-center transition-colors shadow-lg shadow-black/20"
                >
                    +
                </motion.button>
            </div>
            ...
            <div className="flex justify-between pt-8">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 rounded-none font-bold !bg-gradient-to-r !from-violet-600 !to-indigo-600 !text-white shadow-[0_0_30px_rgba(139,92,246,0.2)] hover:shadow-[0_0_40px_rgba(139,92,246,0.4)] transition-all flex items-center gap-3 uppercase tracking-widest text-xs"
                    style={{ fontFamily: 'var(--font-rasputin), serif' }}
                >
