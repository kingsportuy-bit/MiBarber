...
import { V2KanbanColumn } from "@/components/v2/V2KanbanColumn";
...
// Props para el componente V2KanbanBoard
interface V2KanbanBoardProps {
...
export function V2KanbanBoard({ 
  isCreateModalOpen, 
  setIsCreateModalOpen,
  selectedAppointment,
  setSelectedAppointment
}: V2KanbanBoardProps) {
  console.log('V2KanbanBoard props:', { isCreateModalOpen, selectedAppointment });
  ...
  return (
    <div className="w-full">
      ...
      <div className="md:hidden text-center py-8">
        <div className="v2-card p-6 max-w-md mx-auto">
