-- Script final corregido para crear la tabla mibarber_descansos_extra con restricciones de clave foránea correctas
...
BEGIN
    ...
    -- Restricción para id_sucursal (la columna en mibarber_sucursales se llama 'id', no 'id_sucursal')
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
